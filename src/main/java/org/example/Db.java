...
public class Db{
    ...
    static String tableArtists= "create table artists(id INTEGER PRIMARY KEY AUTOINCREMENT  not null, name varchar(100) not null, country varchar(100))";/* aici am creat  tableArtists*/
    static String tableAlbums="create table albums(id integer PRIMARY KEY  AUTOINCREMENT not null ,name varchar(100) not null,artist_id integer not null,release_year integer CONSTRAINT artist_id  FOREIGN KEY(artist_id) REFERENCES artists(id))";/* aici am creat  tableAlbums*/
